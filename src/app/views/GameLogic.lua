...
--特殊类型
GameLogic.CT_EX_INVALID						= 5								--非特殊牌
GameLogic.CT_EX_SANTONGHUA					= 10								--三同花
GameLogic.CT_EX_SANSHUNZI					= 11								--三顺子
GameLogic.CT_EX_LIUDUIBAN					= 20								--六对半
GameLogic.CT_EX_SITAOSANTIAO				= 90								--四套三条
GameLogic.CT_EX_SANFENGTIANXIA				= 110								--三分天下
GameLogic.CT_EX_SANTONGHUASHUN				= 120								--三同花顺
GameLogic.CT_EX_YITIAOLONG					= 160								--一条龙
GameLogic.CT_EX_ZHIZUNQINGLONG				= 170								--至尊清龙
